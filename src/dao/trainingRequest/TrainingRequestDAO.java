...
public class TrainingRequestDAO {
	...
	public void insertTrainingRequest(int requester_id, String vertical, String request_training_type,
			...
			String request_start_date, String request_end_date, String request_location, String request_time_zone,
			int request_approx_participant, int request_project_spoc, String time_requested,
	...
	public void updateTrainingRequest(int training_request_id, int requester_id, String vertical,
			String request_training_type, String request_training_module, String request_training_module_scope,
			String request_training_mode, String request_start_date, String request_end_date, String request_location,
			String request_time_zone, int request_approx_participant, int request_project_spoc, String time_requested,
			String justification_of_request) {
